    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-input bg-background px-5 py-2.5 text-sm text-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
          >
            Ir al inicio
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Wendy Padilla — Desarrollo Personal a través del Ser" },
      {
        name: "description",
        content:
          "Psicóloga, autora y facilitadora. Acompañamiento en autoconocimiento, autoestima y mentoría Kaizen.",
      },
      { name: "author", content: "Wendy Padilla" },
